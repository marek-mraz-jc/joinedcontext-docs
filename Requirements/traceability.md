...
| **DM-01–DM-70** | Data Models & LinkML Editor | `data-models.md` | Portal UI (LinkML Editor), Model Tools image, jcctl `model`, Context Gateway validation | Regeneration diff gate, example-validates test, JSON-LD expansion test, editor Playwright journey, breaking-change classifier tests |
