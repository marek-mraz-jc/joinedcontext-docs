...
| `copy` | `joinedcontext-portal/src/api/import.rs` | `tests/project_duplicate_tests.rs` | `ui/tests/project_duplicate_import.test.tsx` | owed: T-2746 | owed: T-2732 |
...
| `retry-rejected` | `joinedcontext-portal/src/api/internal/pipeline_rejected.rs` | `tests/pipeline_rejected_api_tests.rs` | `ui/tests/pipeline_rejected.test.tsx` | owed: T-2746 | owed: T-2732 |
...
| `try-it` | `joinedcontext-portal/src/agents/data_query.rs` | `tests/edge_resource_reads_tests.rs` | `ui/tests/try_it.test.tsx` | owed: T-2746 | `jc_ask` |
...
| `sync-now` | `joinedcontext-portal/src/sync/driver.rs` | `tests/sync_source_routes_tests.rs` | `ui/tests/sync_sources_view.test.tsx` | owed: T-2746 | `jc_syncsource_sync` |
| `pause` | `joinedcontext-portal/src/sync/state.rs` | `tests/ops_sync_sources_tests.rs` | `ui/tests/sync_sources_view.test.tsx` | owed: T-2746 | `jc_syncsource_pause` |
| `detach` | `joinedcontext-portal/src/sync/state.rs` | `tests/edge_sync_detach_webhook_tests.rs` | `ui/tests/sync_sources_view.test.tsx` | owed: T-2746 | `jc_syncsource_detach` |
| `webhook` | `joinedcontext-portal/src/sync/webhook_secrets.rs` | `tests/sync_webhook_secrets_tests.rs` | `ui/tests/sync_sources_view.test.tsx` | owed: T-2746 | person only: a webhook is the remote repository calling in with its signature; no person or agent takes this step by hand |
...
| `mint-key` | `joinedcontext-portal/src/api/service_accounts.rs` | `tests/ops_service_account_keys_tests.rs` | `ui/tests/service_accounts_view.test.tsx` | owed: T-2746 | person only: a key is a credential shown once to the person who minted it; an agent never receives one (AG-11) |
| `rotate-key` | `joinedcontext-portal/src/api/service_accounts.rs` | `tests/ops_service_account_keys_tests.rs` | `ui/tests/service_accounts_view.test.tsx` | owed: T-2746 | person only: a rotated key is a new credential shown once to a person, never to an agent (AG-11) |
| `revoke-key` | `joinedcontext-portal/src/api/service_accounts.rs` | `tests/edge_key_store_tests.rs` | `ui/tests/service_accounts_view.test.tsx` | owed: T-2746 | `jc_service_account_key_revoke` |
...
| `answer-question` | `joinedcontext-portal/src/api/agent_runs.rs` | `tests/ops_runs_tests.rs` | `ui/tests/question_options.test.tsx` | owed: T-2746 | person only: the run asks the person, and an agent answering its own question would decide for them (AG-11) |
...
| `cancel` | `joinedcontext-portal/src/api/agent_runs.rs` | `tests/ops_runs_tests.rs` | `ui/tests/agent_run.test.tsx` | owed: T-2746 | `jc_run_cancel` |
| `rebuild` | `joinedcontext-portal/src/apps/built.rs` | `tests/app_build_lane_tests.rs` | `ui/tests/app_build_panel.test.tsx` | `ui/e2e/live/apps-samples.spec.ts` › "each sample application is built from its own repository and the catalog says which commit" | owed: T-2732 |
...
| `write-through-form` | `joinedcontext-portal/src/apps/functions.rs` | `tests/apps_functions_tests.rs` | `ui/tests/app_form.test.tsx` | `ui/e2e/live/apps-fullstack.spec.ts` › "a steward adds, corrects and removes a station, and the viewer sees it" | owed: T-2732 |
...
| `approve` | `joinedcontext-portal/src/change.rs` | `tests/changes_tests.rs` | `ui/tests/approval_actions.test.tsx` | `ui/e2e/live/roles-refusals.spec.ts` › "an administrator of the kind approves their own change, and the space is created" | person only: a person approves a change and an agent never does (AG-11, PF-58) |
| `reject` | `joinedcontext-portal/src/change.rs` | `tests/changes_tests.rs` | `ui/tests/approval_actions.test.tsx` | owed: T-2746 | person only: rejecting decides a change as approving does, and only a person decides one (AG-11) |
| `drift-adopt` | `joinedcontext-portal/src/reconciler/drift.rs` | `tests/drift_api_tests.rs` | `ui/tests/drift_modal.test.tsx` | owed: T-2746 | owed: T-2732 |
| `drift-revert` | `joinedcontext-portal/src/reconciler/drift.rs` | `tests/drift_api_tests.rs` | `ui/tests/drift_modal.test.tsx` | owed: T-2746 | owed: T-2732 |
| `blueprint` | `joinedcontext-portal/src/plan.rs` | `tests/ops_flows_tests.rs` | `ui/tests/blueprint_wizard.test.tsx` | owed: T-2746 | `jc_flow_start` |
