...
| **MF** | Manifest Model, Import/Sync/Download | MF-01…MF-50 | [manifests.md](manifests.md) | [Architecture/06-configuration-as-code.md](../Architecture/06-configuration-as-code.md) | [Testing/04-configuration-and-pipeline-tests.md](../Testing/04-configuration-and-pipeline-tests.md) |
| **EP** | Endpoints & Representations | EP-01…EP-90 | [endpoints.md](endpoints.md) | [Architecture/04-context-spaces-and-endpoints.md](../Architecture/04-context-spaces-and-endpoints.md) | [Testing/02-conformance-tests.md](../Testing/02-conformance-tests.md) |
...
| **AG** | Agent & MCP Governance | AG-01…AG-95 | [agents.md](agents.md) | [Architecture/07-agents-and-mcp.md](../Architecture/07-agents-and-mcp.md) | [Testing/06-security-tests.md](../Testing/06-security-tests.md) |
...
| **TS** | Testing & Quality Assurance | TS-01…TS-26 | [testing.md](testing.md) | [Architecture/01-overview.md](../Architecture/01-overview.md) | [Testing/00-strategy.md](../Testing/00-strategy.md) |
| **DM** | Data Models & LinkML Editor | DM-01…DM-79 | [data-models.md](data-models.md) | [Architecture/11-data-models.md](../Architecture/11-data-models.md) | [Testing/02-conformance-tests.md](../Testing/02-conformance-tests.md) |
...
| **OPS** | Operations & Reliability | OPS-01…OPS-52 | [operations.md](operations.md) | [Architecture/13-security.md](../Architecture/13-security.md) | [Testing/05-deployment-and-performance-tests.md](../Testing/05-deployment-and-performance-tests.md) |
| **AP** | Apps on Demand | AP-01…AP-138 | [apps.md](apps.md) | [Architecture/16-apps-on-demand.md](../Architecture/16-apps-on-demand.md) | [Testing/03-frontend-and-e2e-tests.md](../Testing/03-frontend-and-e2e-tests.md) |
