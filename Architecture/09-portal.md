...
| SyncSource, CkanInstance, Blueprint, Mapping, ModelProjection, ScopeDefinition, SharedSpaceReference, ContextSourceRegistration, Layer, UiSchema, Bundle, DataSpaceParticipant, DataOffer, DataAgreement, Project | a page for sync sources, CKAN and flows; a form on the list for DataAgreement and DataOffer (T-1542, T-1543) and on Organization → Blueprints for Blueprint (T-1537); a generic list for the rest | list, get, create, update, delete | none | none |
