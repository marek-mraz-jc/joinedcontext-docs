...
| **AP** | Apps on Demand | AP-01…AP-99 | [apps.md](apps.md) | [Architecture/16-apps-on-demand.md](../Architecture/16-apps-on-demand.md) | [Testing/03-frontend-and-e2e-tests.md](../Testing/03-frontend-and-e2e-tests.md) |
