...
| **EP-01–EP-80** | Endpoints & Parity | `endpoints.md` | Context Gateway, Format Translators, ArcSwap Cache | Representation Parity Tests, OGC ATS, STA Sensing Profile Suite |
...
| **AG-01–AG-92** | Agents & MCP Governance | `agents.md` | Gateway MCP Façade, Portal MCP (`/api/v1/mcp`) over the operation registry, Agent Runner Addon, `jc-agent-proxy` | MCP Spec Conformance Suite, Adversarial Prompt-Injection Tests |
