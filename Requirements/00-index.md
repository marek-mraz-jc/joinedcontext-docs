...
|---|---|---|---|---|---|
| **PF** | Platform & Domain Invariants | PF-01…PF-104 | [platform.md](platform.md) | [Architecture/03-domain-model.md](../Architecture/03-domain-model.md) | [Testing/04-configuration-and-pipeline-tests.md](../Testing/04-configuration-and-pipeline-tests.md) |
