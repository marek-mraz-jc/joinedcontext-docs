...
| **Applications** (`applications`) | every App of every project: title, project, lifecycle, what it builds from | **Export** of one App, its repository as a git bundle beside its manifest; **Import app** into a project under a name, the red-lane `Change` that adds it ([API/01 §10](../API/01-portal-api.md)) |
