...
| `JC_PORTAL_DASHBOARDS` | — | no | Whether the Dashboards section is shown (`JC_PORTAL_DASHBOARDS`, the literal string `true` to show it; default hidden, the owner's call of 2026-09-25, T-2874). |
