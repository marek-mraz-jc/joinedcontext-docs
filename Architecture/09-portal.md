...
| SyncSource, CkanInstance, Blueprint, Mapping, ModelProjection, ScopeDefinition, SharedSpaceReference, ContextSourceRegistration, Layer, UiSchema, Bundle, DataSpaceParticipant, DataOffer, DataAgreement, Project | a page for sync sources, CKAN and flows; a form on the list for DataAgreement and DataOffer (T-1542, T-1543), and on the Organization page for Blueprint and DataSpaceParticipant (T-1537, T-1544); a generic list for the rest | list, get, create, update, delete | none | none |
