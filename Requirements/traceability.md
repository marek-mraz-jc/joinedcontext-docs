...
| **EP-01–EP-89** | Endpoints & Parity | `endpoints.md` | Context Gateway, Format Translators, ArcSwap Cache, Portal catalogue | Representation Parity Tests, OGC ATS, STA Sensing Profile Suite |
...
| **PL-01–PL-63** | Pipeline Execution | `pipelines.md` | Bento Streams Runner, K8s CronJob, NetworkPolicies, derived pipelines (WASM/container compute), any input the runner ships, sources, steps and outputs (ADR-N-023), the workbench and validated writes (ADR-N-034) | `bento lint`, Golden Transformation Tests, Stream Load Tests |
