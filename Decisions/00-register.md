...
| [ADR-N-009](adr-n-009-mcp-surfaces-and-agent-lanes.md) | Model Context Protocol Surfaces and Agent Governance | **Accepted** | 2026-09-05 | Deploys dual MCP surfaces (Data MCP and Config MCP) with Green/Yellow/Red approval lanes and interactive elicitation prompts. |
