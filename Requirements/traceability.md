...
| **EP-01–EP-91** | Endpoints & Parity | `endpoints.md` | Context Gateway, Format Translators, ArcSwap Cache, Portal catalogue | Representation Parity Tests, OGC ATS, STA Sensing Profile Suite |
